        ...
        if (currentStageData.stageName === 'freight_query') {
            ...
            try {
                ...
                if (supplierError && supplierError.code !== 'PGRST116') {
                    ...
                    console.log('✅ Found supplier data:', supplierData);
                    
                    // Map the fields - enhanced mapping with all available fields
                    const mappings = {
                    ...
                    // Apply mappings to form fields (only if field is empty)
                    Object.keys(mappings).forEach(fieldName => {
                        ...
                        if (fieldElement && mappings[fieldName] !== null && mappings[fieldName] !== undefined) {
                            ...
                            if (!fieldElement.value) {
                                ...
                                console.log(`📋 Pre-filled ${fieldName}: ${mappings[fieldName]}`);
                            }
                        }
                    });

                    // Set default sent_at to current datetime if empty
                    ...
                    console.log('ℹ️ No supplier details found yet for this shipment');
                }
            } catch (error) {
...
Direct Data Count: ${directData?.length || 0}`);
    ...
    function renderDocuments() {
        ...
        documentsData.forEach(doc => {
            ...
            card.querySelector('.document-type').textContent = docType;
